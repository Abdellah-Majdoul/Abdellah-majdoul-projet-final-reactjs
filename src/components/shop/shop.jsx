...
const ShopPage = () => {
    ...
    const initialProducts = dataJson.slice(0, 6); 
    ...
    const clickSort = (e) => {
        ...
        const sortedData = [...initialProducts]; 
    ...
    const filterPrice = (min, max) => {
        const filteredProducts = initialProducts.filter(
            product => parseFloat(product.price.replace('$', '')) >= min && parseFloat(product.price.replace('$', '')) <= max
        );
                    ...
                    <div className='flex flex-col gap-[2vh]'>
                        ...
                        <div className='ms-3'>
                            <div className='flex gap-2 items-center'>
                                ...
                                <label className='text-gray-500'>0-20</label>
                            </div>
                            <div className='flex gap-2 items-center'>
                                <input type="checkbox" onChange={() => filterPrice(20, 50)} />
                                <label className='text-gray-500'>20-50</label>
                            </div>
                        </div>
                    </div>
